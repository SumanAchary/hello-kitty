...
output "aws_cloudwatch_log_group_aws_lambda_sud_sum_kitty_function_arn" {
  value = module.appcd_86ec452a-770a-59bf-87dd-67ed883e25e5.arn
  sensitive = false
}


output "aws_cloudwatch_log_group_aws_lambda_sud_sum_kitty_function_name" {
